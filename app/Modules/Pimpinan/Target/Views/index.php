...
<?= $this->section('content') ?>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            Lihat target pajak bulanan (hanya tampilan)
                        </small>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-header border-0 shadow-sm">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            Target Januari sampai Desember
                        </small>
    ...
    <script>
      ...
      const urlData   = "<?= route_to('pimpinan.target.data') ?>";
      const urlGet    = "<?= route_to('pimpinan.target.get') ?>";
      ...
      // ======================================================
      // TAMBAH — dinonaktifkan untuk Pimpinan (hanya lihat)
      // ======================================================
      ...
      // ======================================================
      // SIMPAN / HAPUS — tidak tersedia untuk Pimpinan
      // ======================================================
