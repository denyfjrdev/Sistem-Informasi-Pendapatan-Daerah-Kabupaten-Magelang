  ...
  <div class="row g-3">
    ...
    <div class="col-lg-3">
      <div class="dashboard-card">
        ...
        <form method="get" action="<?= route_to('pimpinan.detil.index') ?>" id="formFilter">
          ...
          <a href="<?= route_to('pimpinan.detil.index') ?>" class="btn btn-light w-100 mt-2">Reset</a>
        </form>
      </div>
    </div>
    ...
    <div class="col-lg-9">
      ...
      <?= $this->include('App\Modules\Pimpinan\Detil\Views\card_summary') ?>

      <?= $this->include('App\Modules\Pimpinan\Detil\Views\card_chart_bulan') ?>
...
<script>
  document.getElementById('kode_kecamatan').addEventListener('change', function () {
    ...
    fetch('<?= route_to('pimpinan.detil.desa') ?>?kode_kecamatan=' + encodeURIComponent(kodeKecamatan))
      .then(r => r.json())
      .then(response => {
