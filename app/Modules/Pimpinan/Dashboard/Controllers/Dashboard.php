<?php 
namespace App\Modules\Pimpinan\Dashboard\Controllers;

use App\Modules\Pimpinan\AdminBaseController;
use App\Modules\Pimpinan\Dashboard\Models\DashboardModel;
...
class Dashboard extends AdminBaseController
{
  ...
  public function __construct(){      
    ...
    $data = [
      ...
      "fiture"          =>  "Beranda Pimpinan",  // Judul besar di samping motif header      
      "hp"              =>  $this->hp,
      "data_user"       =>  $this->data_user,
      "datatables"      =>  true,            
    ...
    return view('App\Modules\Pimpinan\Dashboard\Views\index',$data);
  }
