...
<div class="container-fluid mt-3">
    ...
    <?= view('Modules\Admin\Dashboard\Views\part_cards', compact(
    ...
    <div class="row mt-3 g-3">
        <?= view('Modules\Admin\Dashboard\Views\part_tabel', compact(
            'array_per_jenis_pajak', 'semua_target_tahun', 'semua_realisasi_tahun', 'semua_piutang', 'total_persentase_tahun'
        )) ?>

        <?= view('Modules\Admin\Dashboard\Views\part_grafik', compact(
            'array_per_jenis_pajak'
        )) ?>
    </div>
